...
## AKO Report Generator
The idea behind the AKORG is that at the beggining of a project a games developer can check boxes to identify what type of game they are developing and a report is generated that: 
1. identifies potential accessibility pitfalls,
2. suggests things to consider to avoid them,
3. highlights accessibility design patterns that might help and
