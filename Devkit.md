...
- 1 [Spectrum of sight loss](#1-Spectrum-of-sight-loss) 
- 2 [Feedback welcome](#2-Feedback-welcome)
...
## 6.7	Colour blindness filters
Colour blindness is a condition where parts of the eye that discern colours are missing or not working as standard. Colour blindness filters, using a process called daltonization, applied across the whole game (including menus) can ensure that colours have as much contrast as possible and can make the game easier to play for people who are colourblind. Giving players choice over colours used in game will be enough for some gamers, however.
